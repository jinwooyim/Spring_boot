...
<!--         <form id="recipe_form" class="recipe_write_form" enctype="multipart/form-data"> -->
...
<!--                         <input type="file" id="main_image" name="rc_course_img" accept="image/*" style="display: none;"> -->
...
<!--                                 <input type="file" id="step_image_1" name="rc_course_img[]" accept="image/*" style="display: none;"> -->
            ...
            <div class="form_actions">
                ...
                <button type="button" class="submit_btn" onclick="recipe_write()">레시피 등록</button>
            </div>
        </form>
    </div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    recipeForm.addEventListener('submit', function(e) {
        ...
        // 여기에 폼 제출 로직 추가
        alert('레시피가 등록되었습니다.');
        window.location.href = 'member/profile.jsp'; // 마이페이지로 이동
    });
});
...
function recipe_write() {
    ...
    let queryString = $("#recipe_form").serialize();
    
	//----------------------------------------------
    $.ajax({
        type: "POST",
        url: "recipe/recipe_write",
        data: queryString,
//         processData: false,  // FormData일 경우 반드시 false
//         contentType: false,  // FormData일 경우 반드시 false
